...
export const sectionPagamentoColumns = () : ColumnDef<Pagamento>[] => [
...

  {
    ...
    header: "Alvara",
    cell: ({ row }) => {
      return <p>{row.original.alvara}</p>;
    },
  },

  {
    ...
    header: "Processo",
    cell: ({ row }) => <p>{row.original.processo}</p>,
  },

  {
    accessorKey: "valor",
    header: "Valor",
    cell: ({ row }) => <p>{row.original.valor}</p>,
  },

  {
    accessorKey: "tipo",
    header: "Tipo",
    cell: ({ row }) => <p>{row.original.tipo}</p>,
  },

  {
    accessorKey: "data_registro",
    header: "Data Registro",
    cell: ({ row }) => <p>{row.original.data_registro}</p>,
  },

  {
    accessorKey: "data_prev_pag",
    header: "Data Prev.Pag",
    cell: ({ row }) => <p>{row.original.data_prev_pag}</p>,
  },

  {
    accessorKey: "data_pagamento",
    header: "Data Pagamento",
    cell: ({ row }) => <p>{row.original.data_pagamento}</p>,
  },

  {
    accessorKey: "parcela_n",
    header: "parcela Nº",
    cell: ({ row }) => <p>{row.original.parcela_n}</p>,
  },
